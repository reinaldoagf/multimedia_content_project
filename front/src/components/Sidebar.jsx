  ...
  return (
    <>
      <button
        ...
        type="button"
        className="inline-flex items-center p-2 mt-2 ms-3 text-sm rounded-lg sm:hidden text-gray-900"
      >
        ...
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-200">
          <ul className="space-y-2 font-medium">
            <li>
              <Link
                to="/"
                className="flex items-center p-2 text-gray-900 rounded-lg text-gray-900 hover:bg-gray-100 group"
              >
                <svg
                ...
                <span className="flex-1 ms-3 text-gray-900 whitespace-nowrap">
                  Contenido
                </span>
